...
CREATE TABLE IF NOT EXISTS COSTOS_GENERALES (cfID INT NOT NULL PRIMARY KEY AUTO_INCREMENT,MODELO INT NOT NULL,TIPO_COSTO INT NOT NULL,MAGNITUD DOUBLE,FECHA DATE,UNIQUE index_DDINAMICO (TIPO_COSTO,MODELO,MAGNITUD,FECHA),
